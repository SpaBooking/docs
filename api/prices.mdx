...
not as a quote. A bookable price for concrete dates comes from API v1
[`GET /price`](/api/v1/reference/get-price).
...
The category of a visit type is `stay_category` in API v1
[`GET /visit-types`](/api/v1/reference/get-visit-types).
